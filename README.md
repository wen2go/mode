...
> one date-stamped tag, such as `mode_20260910_v22.0.3`; the `v22.0.3` part is
...
| --- | --- | --- |
| macOS Apple Silicon (ARM64) | [mode_20260910_v22.0.3][mode-release] | `mode_mac_arm_20260910_v22.0.3.tar.gz` |
| Windows x64 | [mode_20260910_v22.0.3][mode-release] | `mode_win_x64_20260910_v22.0.3.zip` |
| Linux x64 | [mode_20260910_v22.0.3][mode-release] | `mode_linux_x64_20260910_v22.0.3.tar.gz` |

On macOS or Linux, extract the archive and place `mode` on `PATH`:

```bash
tar -xzf mode_linux_x64_20260910_v22.0.3.tar.gz
mkdir -p "$HOME/.local/bin"
install -m 755 mode_linux_x64_20260910_v22.0.3/mode "$HOME/.local/bin/mode"
export PATH="$HOME/.local/bin:$PATH"
mode --version
```

Use `mode_mac_arm_20260910_v22.0.3` in the commands above for macOS Apple Silicon.
...
```powershell
Expand-Archive .\mode_win_x64_20260910_v22.0.3.zip
.\mode_win_x64_20260910_v22.0.3\mode.exe --version
```
...
[mode-release]: https://github.com/wen2go/mode/releases/tag/mode_20260910_v22.0.3
